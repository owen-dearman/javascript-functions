...
console.log(
  "'we like cats' // => #WeLikeCats   ",
  generateHashtag("we like cats")
);
console.log(
  "'what even is camel case' // =>  #WhatevenIsCamelCase  ",
  generateHashtag("what even is camel case")
);
console.log(
  "'wUWnYGVQnbZrtUKclvvj LskvAHUvwKjnkHKuJhgHdzNReKjDxiyhRFcjUnkMRFvGkjWQDHYjPuKoZLJDcgEwfeHmSrHImqbCUfevDdW cDfNneGRAifEFbitJsKqbxMMfcvIAkTOemakNEuC' // =>  false  ",
  generateHashtag(
    "wUWnYGVQnbZrtUKclvvj LskvAHUvwKjnkHKuJhgHdzNReKjDxiyhRFcjUnkMRFvGkjWQDHYjPuKoZLJDcgEwfeHmSrHImqbCUfevDdW cDfNneGRAifEFbitJsKqbxMMfcvIAkTOemakNEuC"
  )
);
