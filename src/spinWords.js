...
console.log(
  "'Hello young children of code' // => 'olleH gnuoy nerdlihc of code'   ",
  spinWords("Hello young children of code")
);
console.log(
  "'good gninrom' // => 'good morning'   ",
  spinWords("good gninrom")
);
console.log(
  "'I like the Film' // => 'I like the Film'   ",
  spinWords("I like the Film")
);
