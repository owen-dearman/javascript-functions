function twoDigit(number){
    let singleWords = ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"];
    let endZeroWords = ["", "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety"];
    let teenWords = ["", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"];
...
function threeDigit(number){
    ...
    if (number[number.length-3] == 0 && number[number.length-2] == 0 && number[number.length-1] ==0){
        return ""
...
function fiveDigit(number){
    ...
    if (number[number.length-5] == 0 && number[number.length-4] == 0 && number[number.length-3] == 0 && number[number.length-2] == 0 && number[number.length-1] == 0){
