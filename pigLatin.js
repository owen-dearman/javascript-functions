...
console.log("'Pig Latin is cool' // => 'igPay atinLay siay oolcay' ", pigIt("Pig Latin is cool"))
...
console.log(".map")
console.log("'Pig Latin is cool' // => 'igPay atinLay siay oolcay' ", pigIt2("Pig Latin is cool"))
