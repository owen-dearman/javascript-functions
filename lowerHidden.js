...
console.log("lowerHidden 1 'AbCDEFGHiLKMNopQRsTUVWXyZ' // => 'biopsy'  ", lowerHidden("AbCDEFGHiLKMNopQRsTUVWXyZ"))
console.log("lowerHidden 1 'GDsEwFRGeTTHTYeKFt' // => 'sweet'   ", lowerHidden("GDsEwFRGeTTHTYeKFt"))
console.log("lowerHidden 1 'YFemHUFBbezFBYzFBYLleGBYEFGBMENTment' // => 'embezzlement'  ", lowerHidden("YFemHUFBbezFBYzFBYLleGBYEFGBMENTment"))
console.log("lowerHidden 1 'FDWQSFGoBDSZAwBNeNGDXXCn' // => owen   ", lowerHidden("FDWQSFGoBDSZAwBNeNGDXXCn"))
...
console.log("lowerHidden 2 'AbCDEFGHiLKMNopQRsTUVWXyZ' // => 'biopsy'  ", lowerHidden2("AbCDEFGHiLKMNopQRsTUVWXyZ"))
console.log("lowerHidden 2 'GDsEwFRGeTTHTYeKFt' // => 'sweet'   ", lowerHidden2("GDsEwFRGeTTHTYeKFt"))
console.log("lowerHidden 2 'YFemHUFBbezFBYzFBYLleGBYEFGBMENTment' // => 'embezzlement'  ", lowerHidden2("YFemHUFBbezFBYzFBYLleGBYEFGBMENTment"))
console.log("lowerHidden 2 'FDWQSFGoBDSZAwBNeNGDXXCn' // => owen   ", lowerHidden2("FDWQSFGoBDSZAwBNeNGDXXCn"))
