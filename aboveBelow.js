...
function aboveBelow(numArr, specNum){
    ...
    return `Numbers above ${specNum}: ${countAbove}, Numbers below ${specNum}: ${countBelow}, Mean of array: ${mean.toFixed(2)}`
}

console.log("[1,2,3],2 // => 1,1,2   ",aboveBelow([1,2,3],2))
console.log("[30, 43, 78, 99, 103, 2, 50], 51 // => 3, 4, 57.86   ",aboveBelow([30, 43, 78, 99, 103, 2, 50], 51))
console.log("[39.73, 226, 2.697, 4324, 72.9, 104], 1026 // => 1, 5, 794.93   ",aboveBelow([39.73, 226, 2.697, 4324, 72.9, 104], 1026))
console.log("[0, -3, -5, -7], 0 // => 0,3, -3.5   ",aboveBelow([0, -3, -5, -7], 0 ))